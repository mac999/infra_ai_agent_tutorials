...
def load_and_split_pdfs(path):
	...
	splitter = RecursiveCharacterTextSplitter(chunk_size=CHUNK_SIZE, chunk_overlap=CHUNK_OVERLAP) # chunk_size means how many characters in each chunk, chunk_overlap means how many characters overlap between chunks

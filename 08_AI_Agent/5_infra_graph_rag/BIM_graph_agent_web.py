"""
BIM Graph Agent Web Interface - Simple ChatBot Style

Streamlit web app for BIM data querying using natural language.
Dark mode chatbot interface with minimal design.

Usage: streamlit run BIM_graph_agent_web.py
Contact: Taewook Kang (laputa99999@gmail.com)
"""

import streamlit as st, sys
from pathlib import Path
from BIM_graph_agent import BIMGraphAgent, load_environment
...
if st.session_state.initialized and st.session_state.agent:
    ...
    # Handle input only when Send button is clicked AND there's text
